...
__author__ = "Lukas Beeck, Almut Demel"  # Adjust this when you copy the file
__email__ = "uagru@student.kit.edu, almut@demels.de"  # Adjust this when you copy the file
